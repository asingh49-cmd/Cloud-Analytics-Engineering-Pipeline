...
CREATE TABLE IF NOT EXISTS `sakila_snowflake`.`fact_rental`(
	...
	rental_last_update TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	...
	dollar_amount FLOAT NOT NULL DEFAULT 0.0,
    ...
    FOREIGN KEY (rental_date_key) REFERENCES sakila_snowflake.dim_date(date_key),
    FOREIGN KEY (return_date_key) REFERENCES sakila_snowflake.dim_date(date_key)
);
